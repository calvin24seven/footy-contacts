              ...
              <div className="min-w-[780px]">
                ...
                {selectedIds.size > 0 && (
                  <div className="flex flex-wrap items-center gap-2 px-4 py-2 bg-gold/[0.05] border-b border-gold/20">
                    ...
                    {/* Unlock — only shown if any selected contacts need unlocking */}
                    {toUnlockIds.length > 0 && (
                      <button
                    ...
                    <button
                      ...
                      title="Export unlocked contacts to CSV"
          ...
          <div className="border border-white/[0.06] rounded-xl overflow-hidden">
            <div className="overflow-x-auto">
              <div className="min-w-[780px]">
                {/* Bulk action bar — appears when rows are selected */}
                {selectedIds.size > 0 && (
                  <div className="flex items-center gap-2 px-4 py-2 bg-gold/[0.05] border-b border-gold/20">
                    ...
                    >
                      {bulkUnlocking
                        ...
                        : null}
                      {bulkUnlocking ? "Unlocking…" : `Unlock ${selectedIds.size}`}
                    </button>
