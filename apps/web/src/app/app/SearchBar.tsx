  ...
  return (
    <div className="relative flex items-center">
      ...
      <input
        ...
        autoComplete="off"
        className="w-full pl-10 pr-9 py-3 bg-navy-light text-white rounded-xl border border-gray-600 focus:outline-none focus:border-gold placeholder-gray-500 text-sm transition-colors"
      />
      ...
      {q && (
        <button
          ...
          className="absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 flex items-center justify-center rounded-full text-gray-400 hover:text-white hover:bg-gray-700 transition-colors"
        >
